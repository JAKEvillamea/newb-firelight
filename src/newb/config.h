...
#define NL_GAMMA 2.0                  // 0.3 low ~ 2.0 high
...
#define NL_TINT_LOW  vec3(0.3, 0.4, 1.0) // color tint for dark tone
#define NL_TINT_HIGH vec3(1.0, 0.8, 0.6) // color tint for light tone
...
#define NL_MORNING_SUN_COL vec3(1.0,0.6,0.3)
#define NL_NOON_SUN_COL    vec3(1.0,0.95,0.85)
#define NL_NIGHT_SUN_COL   vec3(0.05,0.07,0.1)

/* Ambient light on terrain (light that is added everywhere) */
#define NL_NETHER_AMBIENT vec3(0.4,0.15,0.05)
#define NL_END_AMBIENT    vec3(0.05,0.02,0.08)

/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(1.0, 0.78, 0.5)  // Warm, natural flame
#define NL_UNDERWATER_TORCH_COL vec3(0.7, 0.6, 0.4)   // Dimmed, filtered by water
#define NL_NETHER_TORCH_COL     vec3(1.0, 0.65, 0.4)  // Slightly more fiery, intense
#define NL_END_TORCH_COL        vec3(0.8, 0.7, 1.0)   // Mystical purple-blue tint
...
#define NL_DAY_ZENITH_COL    vec3(0.13, 0.57, 0.89)
#define NL_DAY_HORIZON_COL   vec3(0.68, 0.85, 0.95)
#define NL_NIGHT_ZENITH_COL  vec3(0.01, 0.01, 0.03)  
#define NL_NIGHT_HORIZON_COL vec3(0.15, 0.18, 0.27)  
#define NL_RAIN_ZENITH_COL   vec3(0.318,0.373,0.478)
#define NL_RAIN_HORIZON_COL  vec3(0.659,0.671,0.694)
#define NL_END_ZENITH_COL    vec3(0.03, 0.03, 0.06)
#define NL_END_HORIZON_COL   vec3(0.2, 0.1, 0.4)
#define NL_DAWN_ZENITH_COL   vec3(0.427,0.502,0.706)
#define NL_DAWN_HORIZON_COL  vec3(0.996,0.859,0.584)
#define NL_DAWN_EDGE_COL     vec3(0.996,0.898,0.706)
...
#define NL_WAVE_SPEED 2.4      // 0.5 slow wave ~ 5.0 very fast wave
//#define NL_EXTRA_PLANTS_WAVE // [toggle] !dont use! wave using texture coords (1.21.0 vanilla 2048x1024)

/* Water */
#define NL_WATER_TRANSPARENCY 0.6        // More translucent; realistic murkiness
#define NL_WATER_BUMP 0.08               // Subtle surface distortion
#define NL_WATER_WAVE_SPEED 0.4          // Calmer, natural wave movement
#define NL_WATER_TEX_OPACITY 0.5         // Slight texture; not overly stylized
#define NL_WATER_WAVE                    // Keep wave effect on
//#define NL_WATER_CLOUD_REFLECTION        // Reflections for realism
//#define NL_WATER_REFL_MASK              // Still disabled for simplicity
#define NL_WATER_TINT vec3(0.28, 0.45, 0.6) // Soft blue-green for natural water

/* Underwater*/
#define NL_UNDERWATER_BRIGHTNESS 0.4         // 0.0 dark ~ 3.0 bright
#define NL_CAUSTIC_INTENSITY 1.2             // 0.5 weak ~ 5.0 bright
...
#define NL_CLOUD3_SCALE vec2(0.04, 0.06) // 0.003 large ~ 1.0 tiny
#define NL_CLOUD3_SPEED 0.007            // 0.0 static ~ 4.0 fast moving
#define NL_CLOUD3_SHADOW 1.0             // 0.1 subtle ~ 1.0 dark
...
#define NL_SUNMOON_SIZE 0.7     // 0.3 tiny ~ 4.0 massive

/* Fake godrays during sunrise/sunset */
#define NL_GODRAY 1.9 // [toggle] 0.1 subtle ~ 0.8 strong
...
#define NL_ENTITY_BRIGHTNESS     0.85 // 0.1 dark ~ 1.6 bright
